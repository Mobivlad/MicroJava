...
public abstract class MJMulAssignStatementNode extends MJStatementNode {
    @Child MJVarValueNode var;
    private static final String errorMessage = "Error #000: Lazy programmer";

    public MJMulAssignStatementNode(String varName) {
        super();
    ...
    public void doAssign(VirtualFrame frame, int value) {
        ...
        if (o instanceof String) {
            ...
            var.getSymbol(frame).setResult(sb.toString());
            return;
        }
